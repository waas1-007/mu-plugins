                ...
                <div class="plate">
                    <div class="row pt-3 pb-3">
                        <div class="col-12">
                            ...
                            <p>How to install the TickTok tag and how to get the ID: <a href="https://www.youtube.com/watch?v=vWRZc66eaPo" target="_blank">watch video</a></p>-->
                        </div>
                    </div>
                </div>
...
<div class="card">
    ...
    <div class="card-body show" style="display: block;">
        ...
        <?php if(isWooCommerceActive()) : ?>
            <p>You have <?=$wooEvents?> Shop active events. You can control them on the <a href="<?=buildAdminUrl( 'pixelyoursite', 'woo' )?>">Shop page</a>.</p>
        <?php endif; ?>
        <?php if(isEddActive()) : ?>
...
<div class="panel">
    ...
    <div class="row mb-3">
        <div class="col">
            ...
            <h4 class="switcher-label">Add enriched order's data to Shop's default "New Order" email.</h4>
    ...
    <div class="row mb-3">
        <div class="col">
            ...
            <h4 class="switcher-label">Add enriched order's data to Shop's order details pages.</h4>
        </div>
    </div>
