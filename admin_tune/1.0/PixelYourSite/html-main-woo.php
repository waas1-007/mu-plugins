...
<div class="card card-static">
    <div class="card-header">
        Facebook for Shop Integration
    </div>
    <div class="card-body">
        <div class="row">
            <div class="col">
                <p><strong>It looks like you're using both PixelYourSite and Facebook for Shop Extension. Good, because
                they can do a great job together!</strong></p>
                <p>Facebook for Shop Extension is a useful free tool that lets you import your products to a Facebook
        ...
        <div class="row mb-3">
            <div class="col">
                <div class="custom-controls-stacked">
                    <?php Facebook()->render_radio_input( 'woo_content_id_logic', 'facebook_for_woocommerce', 'Use Facebook for Shop extension content_id logic' ); ?>
        ...
        <div class="row">
            <div class="col">
                <p><em>* If you plan to use the product catalog created by Facebook for Shop Extension, use the
                    Facebook for Shop Extension ID. If you plan to use older product catalogs, or new ones created
...
<div class="row mt-3">
    <div class="col">
        <p class="mb-0">*This event will be fired on the order-received, the default Shop "thank you
...
<div class="card">
    <div class="card-header has_switch">
        <?php PYS()->render_switcher_input('woo_affiliate_enabled');?> Track Shop affiliate button clicks <?php cardCollapseBtn(); ?>
    </div>
    <div class="card-body">
...
<div class="card">
    <div class="card-header has_switch">
        <?php PYS()->render_switcher_input('woo_paypal_enabled');?>Track Shop PayPal Standard clicks <?php cardCollapseBtn(); ?>
    </div>
    <div class="card-body">
...
<?php /*
<h2 class="section-title">Shop Parameters</h2>

<!-- About  Events -->
<div class="card card-static">
    <div class="card-header">
        About Shop Events Parameters
    </div>
    <div class="card-body">
        <div class="row">
            <div class="col">
...
<div class="card">
    <div class="card-header">
        Control the Shop Parameters <?php cardCollapseBtn(); ?>
    </div>
    <div class="card-body">
        <div class="row">
            <div class="col">
