            ...
            <div class="row mb-3">
                <div class="col">
                    <nav class="nav nav-tabs">
						...
						<?php
						$PrimaryNavTabs = getAdminPrimaryNavTabs();
						//$PrimaryNavTabs['woo']['name'] = 'Shop';
						unset($PrimaryNavTabs['woo']);
						unset($PrimaryNavTabs['gdpr']);
						
						foreach ( $PrimaryNavTabs as $tab_key => $tab_data ) : ?>
            ...
            <div class="row">
                    ...
                    switch ( getCurrentAdminTab() ) {
                        ...
                        case 'events':
                            if ( getCurrentAdminAction() == 'edit' ) {
	                            include PYS_PATH . "/includes/views/html-main-events-edit.php";
                            } else {
	                    ...
	                    case 'edd':
		                    include PYS_PATH . "/includes/views/html-main-edd.php";
		                    break;
                        case 'wcf':
                            include PYS_PATH . "/includes/views/html-main-wcf.php";
                            break;

                        case 'head_footer':
                            /** @noinspection PhpIncludeInspection */
                            //include PYS_PATH . '/modules/head_footer/views/html-admin-page.php';
                            include 'modules/head_footer/views/html-admin-page.php';
                            break;
                        ...
                        case 'tiktok_settings':
                            ...
                            break;
                        case 'gdpr':
	                        include PYS_PATH . "/includes/views/html-gdpr.php";
                            break;
                            
                        case 'reset_settings':
	                        include PYS_PATH . "/includes/views/html-reset.php";
	                        break;
                        case 'logs':
                            include PYS_PATH . "/includes/views/html-logs.php";
                            break;
                ...
                <div class="col-3">
                    <nav class="nav nav-pills flex-column mb-3">
                        ...
                        <?php /* <a href="<?php echo esc_url( buildAdminUrl( 'pixelyoursite', 'logs' ) ); ?>"
