        ...
        ?>
            ...
            <!--<div class="row align-items-center">
                <div class="col-2 py-2">
                    <img class="tag-logo" src="<?php echo PYS_URL; ?>/dist/images/microsoft-small-square.png">
                </div>
                <div class="col-10">
                    <h4 class="label">Microsoft the UET Tag (Bing) with <a href="https://www.pixelyoursite.com/bing-tag?utm_source=pixelyoursite-pro-plugin&utm_medium=plugin&utm_campaign=pro-plugin-bing" target="_blank">this pro add-on.</a></h4>
                </div>
            </div>
            <hr>-->
