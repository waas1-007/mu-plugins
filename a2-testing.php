...
add_action( 'waas1_tenant_lifecycle_post_restrictions_group_change', 'test_007_restrict_plugins' );
function test_007_restrict_plugins() {
	
	
	//do not process this logic on every page request.
	//come up with a smart way of doing it once every 1 hour or 2 hour.
	//or use object cache.
	//or use wp transists

     if( WAAS1_RESTRICTION_GROUP_ID == 4 ){
